...
import { idlFactory } from './day_3.did.js';
export { idlFactory } from './day_3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY_3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day_3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day_3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day_3.did.js")._SERVICE>}
 */
export const day_3 = createActor(canisterId);
