...
import { idlFactory } from './day_4.did.js';
export { idlFactory } from './day_4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY_4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day_4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day_4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day_4.did.js")._SERVICE>}
 */
export const day_4 = createActor(canisterId);
