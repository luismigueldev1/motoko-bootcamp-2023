...
import { idlFactory } from './day_2.did.js';
export { idlFactory } from './day_2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY_2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day_2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day_2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day_2.did.js")._SERVICE>}
 */
export const day_2 = createActor(canisterId);
