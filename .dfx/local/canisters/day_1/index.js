...
import { idlFactory } from './day_1.did.js';
export { idlFactory } from './day_1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY_1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day_1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day_1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day_1.did.js")._SERVICE>}
 */
export const day_1 = createActor(canisterId);
